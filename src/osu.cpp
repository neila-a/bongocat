...
bool left_key_state = true;
bool right_key_state = true;
bool wave_key_state = true;
bool previous_smoke_key_state = true;
bool current_smoke_key_state = true;
bool is_toggle_smoke = true;
...
bool init() {
    ...
    // importing sprites
    up.setTexture(data::load_texture("files/osu/up.png"));
    left.setTexture(data::load_texture("files/osu/left.png"));
    right.setTexture(data::load_texture("files/osu/right.png"));
    wave.setTexture(data::load_texture("files/osu/wave.png"));
    if (is_mouse) {
        bg.setTexture(data::load_texture("files/osu/mousebg.png"));
        device.setTexture(data::load_texture("files/osu/mouse.png"), true);
    } else {
        bg.setTexture(data::load_texture("files/osu/tabletbg.png"));
        device.setTexture(data::load_texture("files/osu/tablet.png"), true);
    }
    smoke.setTexture(data::load_texture("files/osu/smoke.png"));
