...
bool init() {
    ...
    // importing sprites
    bg.setTexture(data::load_texture("files/taiko/bg.png"));
    up[0].setTexture(data::load_texture("files/taiko/leftup.png"));
    rim[0].setTexture(data::load_texture("files/taiko/leftrim.png"));
    centre[0].setTexture(data::load_texture("files/taiko/leftcentre.png"));
    up[1].setTexture(data::load_texture("files/taiko/rightup.png"));
    rim[1].setTexture(data::load_texture("files/taiko/rightrim.png"));
    centre[1].setTexture(data::load_texture("files/taiko/rightcentre.png"));
